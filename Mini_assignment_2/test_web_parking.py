...
class Test:
    ...
    def test_cost_and_time(self):
        ...
        self.driver.find_element(By.XPATH, "//input[@id='entryTime']").send_keys("12:00")
        # Set Exit Date
        self.driver.find_element(By.XPATH, "//input[@id='exitDate']").clear()
        self.driver.find_element(By.XPATH, "//input[@id='exitDate']").send_keys("2023-06-07")
        # Set Exit Time
        self.driver.find_element(By.XPATH, "//input[@id='exitTime']").clear()
        self.driver.find_element(By.XPATH, "//input[@id='exitTime']").send_keys("12:00")
